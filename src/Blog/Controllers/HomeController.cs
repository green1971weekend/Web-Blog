    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(int pageNumber, string category, string search)
        {
            ...
            var vm = new IndexViewModel
            {
                ...
                Pages = postCollection.Pages,
                PageCount = postCollection.PageCount,
                PageNumber = postCollection.PageNumber,
                NextPage = postCollection.NextPage,
                Category = postCollection.Category,
